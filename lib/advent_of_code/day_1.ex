defmodule AdventOfCode.Day1 do
  ...
  def measure_check() do
    {count, _} = get_input("day_1_input.txt")
    ...
    |> Enum.reduce(0, fn {_, index},sum ->
      ...
      case Enum.at(list_of_numbers, jump_index+1) do
        ...
        value when value != nil ->
          prev_window = Enum.at(list_of_numbers, jump_index-2) + Enum.at(list_of_numbers, jump_index-1) + Enum.at(list_of_numbers, jump_index)
          next_window = Enum.at(list_of_numbers, jump_index-1) + Enum.at(list_of_numbers, jump_index) + Enum.at(list_of_numbers, jump_index+1)
